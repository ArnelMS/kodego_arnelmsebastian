...
//Implement Activity 01 - C using data structure.
    ...
    var groceryMenu = mutableMapOf<Int, String>()

    var groceryItems = mutableSetOf<String>()
//    println(groceryItems)

    groceryMenu.put (1, "Apple")
    println("Grocery Menu $groceryMenu")


    groceryItems.add ("Apple")
    groceryItems.add ("Toothpaste")
    groceryItems.add ("Pork Chop")
    groceryItems.add ("Lettuce")
    groceryItems.add ("Baygon")
    groceryItems.add ("Apple")
